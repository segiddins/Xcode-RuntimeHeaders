...
- (id <DVTCancellable>)takeWatchPowerAssertionWithName:(NSString *)arg1 details:(NSString *)arg2 andTimeout:(double)arg3;
...
- (void)fetchApplications:(void (^)(NSError *))arg1;
...
- (BOOL)uninstallProvisioningProfile:(DVTProvisioningProfile *)arg1 withError:(id *)arg2;
- (BOOL)installProvisioningProfiles:(id)arg1 withError:(id *)arg2;
- (BOOL)installProvisioningProfile:(DVTProvisioningProfile *)arg1 withError:(id *)arg2;
