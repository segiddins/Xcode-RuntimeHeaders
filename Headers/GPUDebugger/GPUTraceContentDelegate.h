...
#import <GPUDebugger/IDEDebugNavigableContentDelegate-Protocol.h>

@class DVTStackBacktrace, GPUDebuggingAdditionUIController, GPUFilterCompletionsEngine, GPUFilterTokenHelper, GPUNavigableItemFilteringCoordinator, GPUNavigatorFilterControlBar, GPUSharedTabUIState, GPUTraceDisplayableItem, GPUTracePopover, GPUTraceProcessItem, IDEDebugNavigator, IDEDebugSession, IDENavigatorOutlineView, NSArray, NSMenuItem, NSString, NSTrackingArea;
