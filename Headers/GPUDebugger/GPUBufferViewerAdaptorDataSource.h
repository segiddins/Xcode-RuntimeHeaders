...
#import <GPUDebugger/GPUBufferViewerDataSource-Protocol.h>
...
@interface GPUBufferViewerAdaptorDataSource : NSObject <GPUBufferViewerDataSource>
{
    ...
    unsigned long long _rowsPerAmplification;
...
@property(nonatomic) unsigned long long rowsPerAmplification; // @synthesize rowsPerAmplification=_rowsPerAmplification;
...
- (BOOL)expandStruct:(const struct Struct *)arg1 arrayElementOffset:(unsigned long long)arg2 argumentBufferIndex:(unsigned long long)arg3;
