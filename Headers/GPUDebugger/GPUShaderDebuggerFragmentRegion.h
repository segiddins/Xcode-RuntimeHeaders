...
#import <GPUDebugger/DYPShaderDebuggerROIFragment-Protocol.h>
#import <GPUDebugger/DYPShaderDebuggerROILocationFragment-Protocol.h>
...
@property(readonly, nonatomic) unsigned long long renderTargetArrayIndex; // @synthesize renderTargetArrayIndex=_renderTargetArrayIndex;
...
- (id)initWithMinPosition:(unsigned long long)arg1 minSampleId:(unsigned long long)arg2 maxPosition:(unsigned long long)arg3 maxSampleId:(unsigned long long)arg4 renderTargetArrayIndex:selectedPosition:selectedSampleId: /* Error: Ran out of types for this method. */;
