...
#import <GPUDebugger/IDETraceInferiorSession-Protocol.h>

@class DVTObservingToken, DVTStackBacktrace, DYCaptureArchive, DYCaptureSession, DYCaptureSessionInfo, DYFuture, DYGuestAppSession, DYProgressDigest, GPUCaptureMessage, GPUDebuggerController, GPUSourceIndexer, GPUTraceSession, IDELaunchSession, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSString;
...
@property(readonly) GPUSourceIndexer *sourceIndexer; // @synthesize sourceIndexer=_sourceIndexer;
...
- (void)clearPendingTraceSessionEstablishedJobsQueue;
