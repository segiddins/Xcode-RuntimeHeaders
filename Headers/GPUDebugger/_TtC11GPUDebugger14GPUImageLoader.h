...
+ (id)renderPixelPreviewColorComponentsWithTexture:(id)arg1 renderingAttributes:(id)arg2 error:(id *)arg3;
+ (id)renderPixelPreviewComponentsWithTexture:(id)arg1 pixelFormat:(unsigned int)arg2 error:(id *)arg3;
...
+ (id)loadWithResource:(id)arg1 level:(long long)arg2 layer:(long long)arg3 component:(unsigned long long)arg4 error:(id *)arg5;
+ (long long)getPixelFormatCategoryWithResource:(id)arg1;
