...
@class DVTBorderedView, DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, DVTScopeBarView, MISSING_TYPE, NSArrayController, NSButton, NSPopUpButton, NSProgressIndicator, NSString, NSView, SCNNode, SCNScene, SKEDisplayOptionPopupController, SKEPopUpButton, SKESceneEditor, SKESceneView;
...
@interface SKECanvasViewController : IDEViewController <NSMenuDelegate>
{
    ...
    SKEPopUpButton *_aspectRatioPopUp;
...
- (void)toggleDefaultLightingButton:(id)arg1;
