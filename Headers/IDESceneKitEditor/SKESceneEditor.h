...
@class DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, DVTReplacementView, DVTSplitView, MISSING_TYPE, NSArray, NSString, NSView, SCNNode, SKEBakeSettingsWindowController, SKECanvasViewController, SKEDocumentStructureViewController, SKEPreferencesManager, SKESceneEditorArea;
...
- (void)createLightReflectionProbe:(id)arg1;
...
- (void)authoringDisplayMaskShowOriginDidChange:(id)arg1;
...
- (void)_copyURLIntoProject:(id)arg1 to:(id)arg2;
...
- (MISSING_TYPE *)_orbitAtPoint:(struct CGPoint)arg1 forView:(id)arg2 globalBoundingSphere:(out union **)arg3;
