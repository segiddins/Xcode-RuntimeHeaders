...
@optional
- (void)inputHandlerForGraph:(DTTimelineGraph *)arg1 didChangeMouseInteractionInProgress:(BOOL)arg2;
...
- (void)inputHandlerForGraph:(DTTimelineGraph *)arg1 clickableGlyphClickedOnPlane:(DTTimelinePlane *)arg2 relativeRect:(struct CGRect)arg3 completionBlock:(void (^)(void))arg4;
- (void)inputHandlerForGraph:(DTTimelineGraph *)arg1 requestsPlaneHandleWidth:(double)arg2;
- (unsigned long long)inputHandlerRequestsToGetAllowedPlanesHandleResizingForGraph:(DTTimelineGraph *)arg1;
@end
