...
@class DVT_VMUDebugTimer, DVT_VMUProcessObjectGraph, DVT_VMUTaskMemoryScanner, NSMutableArray;
@protocol VMUStackLogReader;

@interface DVT_VMULeakDetector : NSObject
{
...
@property(readonly, nonatomic) DVT_VMUTaskMemoryScanner *scanner; // @synthesize scanner=_scanner;
@property(readonly, nonatomic) DVT_VMUProcessObjectGraph *graph; // @synthesize graph=_graph;
