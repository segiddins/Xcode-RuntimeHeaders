...
@class DVTBorderedView, DVTComparisonScrollCoordinator, DVTComparisonSplitView, DVTDiffSession, DVTNotificationToken, DVTObservingToken, IDEEditor, IDEEditorDocument, IDESourceCodeVersionsLayoutView, IDESourceControlMergeData, NSDictionary, NSString, _TtC29IDESourceCodeComparisonEditor18TwoUpVisualization;
