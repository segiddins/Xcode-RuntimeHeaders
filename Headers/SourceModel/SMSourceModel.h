...
@class CharStream, SMSourceModelItem, SourceModelParser, SourceScanner;
@protocol SMSourceBufferProvider;
...
@interface SMSourceModel : NSObject
{
    ...
    SMSourceModelItem *_sourceItems;
    BOOL _isDoingBatchEdit;
    SourceModelParser *_nativeParser;
}
...
- (id)methodDeclaratorItemAtLocation:(unsigned long long)arg1;
...
- (id)parameterNameItemFromItem:(id)arg1;
- (id)parameterDescriptionItems;
