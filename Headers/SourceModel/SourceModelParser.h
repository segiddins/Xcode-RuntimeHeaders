...
@class NSMutableArray, NSMutableIndexSet, SMLanguageSpecification;

@interface SourceModelParser : NSObject
{
    SMLanguageSpecification *_langSpec;
    long long _langId;
    long long _langToken;
    CDStruct_4d612623 _currentToken;
...
- (id)_parse:(id)arg1 inScope:(id)arg2 node:(id)arg3 outOfBand:(long long)arg4 depth:(long long)arg5;
