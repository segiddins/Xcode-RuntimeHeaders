...
@interface SMSourceSpecification : NSObject
{
    NSString *_identifier;
    NSString *_superSpecIdentifier;
    SMSourceSpecification *_superSpecification;
    NSDictionary *_properties;
}

+ (void)registerMissingSpecification:(id)arg1 forIdentifier:(id)arg2;
+ (id)missingSpecificationForIdentifier:(id)arg1;
...
@property(readonly) SMSourceSpecification *superSpecification; // @synthesize superSpecification=_superSpecification;
