...
@interface SourceModelParserProductionRule : NSObject
{
    ...
    SMLanguageSpecification *_endProduction;
    SMLanguageSpecification *_altEndProduction;
    NSArray *_predictSet;
...
@property(nonatomic) SMLanguageSpecification *altEndProduction; // @synthesize altEndProduction=_altEndProduction;
@property(nonatomic) int altEndToken; // @synthesize altEndToken=_altEndToken;
@property(nonatomic) SMLanguageSpecification *endProduction; // @synthesize endProduction=_endProduction;
