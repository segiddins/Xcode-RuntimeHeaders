...
@class DVTDocumentLocation, DVTFileDataType, DVTObservingToken, DVTSymbol, IDEFileReference, IDEWorkspace, NSArray, NSImage, NSMapTable, NSMutableArray, NSNull, NSString, NSURL;
