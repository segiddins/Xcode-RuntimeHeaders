...
@class DVTDocumentLocation, DVTFileDataType, DVTObservingToken, DVTSymbol, IDEFileReference, NSArray, NSImage, NSMapTable, NSMutableArray, NSNull, NSString, NSURL;
