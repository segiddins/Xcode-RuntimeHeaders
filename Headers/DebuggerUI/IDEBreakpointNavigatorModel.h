...
@class DVTDocumentLocation, DVTFileDataType, DVTObservingToken, DVTStackBacktrace, DVTSymbol, IDEFileReference, IDEWorkspace, NSArray, NSImage, NSMutableArray, NSMutableSet, NSNull, NSString, NSURL;
