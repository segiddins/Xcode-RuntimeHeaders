...
#import <IDEFoundation/IDERuntimeIssueBreakpoint.h>
...
@interface IDERuntimeIssueBreakpoint (IDEBreakpointNavigatorSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
