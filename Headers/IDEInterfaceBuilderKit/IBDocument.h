...
+ (void)transferDocumentlessObjectMetaDataFormObject:(id)arg1 toContainer:(id)arg2;
+ (void)recordDocumentlessMetadataWithContainer:(id)arg1 during:(CDUnknownBlockType)arg2;
+ (void)recordDocumentlessMetadataDuring:(CDUnknownBlockType)arg1;
+ (id)documentlessObjectContainer;
+ (BOOL)setDocumentlessMetadataIfPossibleWithValue:(id)arg1 forKey:(id)arg2 ofObject:(id)arg3;
+ (void)endRecordingDocumentlessMetadata;
+ (void)beginRecordingDocumentlessMetadata;
...
- (BOOL)preflightUnarchivingDocumentHandlingWithConfiguration:(id)arg1 willUseConfigurations:(BOOL)arg2 error:(id *)arg3;
...
- (id)_deviceSubtypesUsingConfigurations:(BOOL)arg1;
- (id)deviceSubtypesForDeviceBar;
- (id)deviceSubtypes;
...
- (id)nameForDocumentSystemColor:(id)arg1;
...
- (void)invalidatePropertyForConnection:(id)arg1;
...
- (void)registerEndPointProviderIfNecessary:(id)arg1 forView:(id)arg2;
...
- (void)renameObject:(id)arg1 toMemberID:(id)arg2;
...
- (void)objectContainer:(id)arg1 didRenameObject:(id)arg2 fromMemberID:(id)arg3 toMemberID:(id)arg4;
