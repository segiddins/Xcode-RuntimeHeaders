...
+ (id)keyPathsForValuesAffectingIbDesignAutoresizingMask;
...
- (BOOL)ibIsExplicitTranslatesAutoresizingMaskIntoConstraintsUninitialized;
@property(nonatomic) BOOL ibExternalExplicitTranslatesAutoresizingMaskIntoConstraints;
- (CDUnknownBlockType)ibTranslatesAutoresizingMaskIntoConstraintsMetadataDependencyKeyBlock;
...
@property(nonatomic) struct CGSize ibDirectFrameSize;
@property(nonatomic) struct CGRect ibDirectFrame;
@property(nonatomic) unsigned long long ibDirectAutoresizingMask;
@property(nonatomic) struct CGSize ibDesignFrameSize;
...
- (id)ibConstraintToMemberIDMapForConstraints:(id)arg1 document:(id)arg2;
- (id)ibConstraintToConnectionsMapForConstraints:(id)arg1 document:(id)arg2;
...
@property(readonly, nonatomic) BOOL ibWantsDocumentContentView;
...
- (id)ibLayoutTree;
- (id)ibLayoutTopDocumentView;
- (id)ibLayoutTopLevelView;
