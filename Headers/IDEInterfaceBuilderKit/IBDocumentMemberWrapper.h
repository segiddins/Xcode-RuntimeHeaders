...
@class DVTDocumentLocation, DVTFileDataType, DVTStackBacktrace, DVTSymbol, IBDocument, IBDocumentMemberLocation, IBMemberID, IDEFileReference, NSArray, NSImage, NSMutableSet, NSNull, NSString, NSURL;
