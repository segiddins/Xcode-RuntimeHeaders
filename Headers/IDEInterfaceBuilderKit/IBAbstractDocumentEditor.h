...
- (void)updateFramesToMatchConstraintsForScope:(long long)arg1;
...
- (void)forceUpdateAllFramesToMatchConstraints:(id)arg1;
- (BOOL)hasAnySelectedObjects;
