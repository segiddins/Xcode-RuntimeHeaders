...
- (id)ibSourceObjectForCodeInsertion;
...
- (id)ibOrderedMenuIndicatorsInStoryboard:(id)arg1;
...
- (void)ibAddExternalUserDefinedRuntimeAttributeForBackwardsDeployment:(id)arg1;
