...
+ (BOOL)canAddVerticalSpacingConstraintBetweenItem:(id)arg1 andSibling:(id)arg2 document:(id)arg3 returningItem1Attribute:(unsigned long long *)arg4 andItem2Attribute:(unsigned long long *)arg5 constant:(id *)arg6;
+ (BOOL)canAddHorizontalSpacingConstraintBetweenItem:(id)arg1 andSibling:(id)arg2 document:(id)arg3 returningItem1Attribute:(unsigned long long *)arg4 andItem2Attribute:(unsigned long long *)arg5 constant:(id *)arg6;
