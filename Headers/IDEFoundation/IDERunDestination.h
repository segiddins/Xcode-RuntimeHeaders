...
@class DVTDevice, DVTObservingToken, DVTSDK, DVTSDKVariant, NSError, NSString;
...
- (void)dealloc;
- (id)initWithIneligibleTargetDevice:(id)arg1 architecture:(id)arg2 SDK:(id)arg3 SDKVariant:(id)arg4 deviceIneligibilityError:(id)arg5;
- (id)initWithTargetDevice:(id)arg1 architecture:(id)arg2 SDK:(id)arg3 SDKVariant:(id)arg4;
