...
- (void)testRunner:(IDETestRunner *)arg1 didFinishTest:(NSString *)arg2 withTestResult:(IDETestResult *)arg3 rawOutput:(NSString *)arg4;
- (void)testRunner:(IDETestRunner *)arg1 didFailTest:(NSString *)arg2 withTestResultMessage:(IDETestResultMessage *)arg3 rawOutput:(NSString *)arg4;
- (void)testRunner:(IDETestRunner *)arg1 test:(NSString *)arg2 didMeasurePerformanceMetric:(DVTTestPerformanceMetricOutput *)arg3 rawOutput:(NSString *)arg4;
- (void)testRunner:(IDETestRunner *)arg1 didOutput:(NSString *)arg2;
- (void)testRunner:(IDETestRunner *)arg1 test:(NSString *)arg2 didFinishActivity:(XCActivityRecord *)arg3;
- (void)testRunner:(IDETestRunner *)arg1 test:(NSString *)arg2 willStartActivity:(XCActivityRecord *)arg3;
- (void)testRunner:(IDETestRunner *)arg1 didStartTest:(NSString *)arg2 withRawOutput:(NSString *)arg3;
