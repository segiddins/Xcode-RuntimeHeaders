...
@class DVTDispatchLock, DVTLogAspect, IDEITunesConnectProxy, IDEITunesSoftwareServiceApplicationDescriptionCache, NSMutableArray, NSString;
...
- (void)executeBlockWithAccountCredentials:(id)arg1 authenticationAttempts:(long long)arg2 block:(CDUnknownBlockType)arg3;
