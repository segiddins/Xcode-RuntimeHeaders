...
@interface IDEDebugSession : NSObject <DVTInvalidation>
{
    ...
    BOOL _shouldDetachForRequestStop;
    BOOL _shouldIgnoreKillSignals;
...
@property BOOL shouldIgnoreKillSignals; // @synthesize shouldIgnoreKillSignals=_shouldIgnoreKillSignals;
@property BOOL shouldDetachForRequestStop; // @synthesize shouldDetachForRequestStop=_shouldDetachForRequestStop;
...
- (void)setIdentifier:(unsigned long long)arg1 forBreakpointLocation:(id)arg2 parentBreakpoint:(id)arg3;
- (unsigned long long)identifierForBreakpointLocation:(id)arg1;
- (id)breakpointLocationForIdentifier:(unsigned long long)arg1 parentBreakpoint:(id)arg2;
...
- (id)_descriptionStringForState:(int)arg1;
