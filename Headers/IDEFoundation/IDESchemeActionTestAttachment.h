...
@class IDEResultReference, NSData, NSDate, NSDictionary, NSString, NSUUID, _TtC13DVTFoundation14DVTFilePromise;
...
- (BOOL)savePayloadToIDEWriter:(id)arg1 error:(id *)arg2;
