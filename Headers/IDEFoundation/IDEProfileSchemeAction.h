...
- (id)_profileOperationForSchemeOperationParameters:(id)arg1 buildOperation:(id)arg2 buildParameters:(id)arg3 buildableProductDirectories:(id)arg4 overridingTestingSpecifiers:(id)arg5 schemeActionRecord:(id)arg6 environmentVariables:(id)arg7 commandLineArguments:(id)arg8 outError:(id *)arg9;
- (id)_UITestOperationForSchemeOperationParameters:(id)arg1 buildOperation:(id)arg2 buildParameters:(id)arg3 buildableProductDirectories:(id)arg4 overridingTestingSpecifier:(id)arg5 schemeActionRecord:(id)arg6 environmentVariables:(id)arg7 commandLineArguments:(id)arg8 testManager:(id)arg9 outError:(id *)arg10;
- (id)_operationGroupWithSchemeOperationParameters:(id)arg1 buildOperation:(id)arg2 buildParameters:(id)arg3 buildableProductDirectories:(id)arg4 testManager:(id)arg5 overridingTestingSpecifiers:(id)arg6 schemeActionRecord:(id)arg7 environmentVariables:(id)arg8 commandLineArguments:(id)arg9 outError:(id *)arg10 actionCallbackBlock:(CDUnknownBlockType)arg11;
- (id)profileOperationWithSchemeOperationParameters:(id)arg1 buildOperation:(id)arg2 buildParameters:(id)arg3 buildableProductDirectories:(id)arg4 schemeActionRecord:(id)arg5 outError:(id *)arg6 actionCallbackBlock:(CDUnknownBlockType)arg7;
- (id)profileOperationWithSchemeOperationParameters:(id)arg1 testManager:(id)arg2 buildOperation:(id)arg3 buildParameters:(id)arg4 buildableProductDirectories:(id)arg5 overridingTestingSpecifiers:(id)arg6 schemeActionRecord:(id)arg7 outError:(id *)arg8 actionCallbackBlock:(CDUnknownBlockType)arg9;
