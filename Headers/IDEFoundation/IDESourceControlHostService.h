...
- (void)commonAncestor:(id)arg1 account:(id)arg2 repository:(id)arg3 sourceBranch:(id)arg4 targetBranch:(id)arg5 reply:(CDUnknownBlockType)arg6;
- (void)fetchParticipants:(id)arg1 account:(id)arg2 repository:(id)arg3 pullRequest:(id)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)exportFile:(id)arg1 account:(id)arg2 file:(id)arg3 revision:(id)arg4 repositoryURL:(id)arg5 reply:(CDUnknownBlockType)arg6;
...
- (void)commitDetails:(id)arg1 account:(id)arg2 repository:(id)arg3 revision:(id)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)searchBranches:(id)arg1 account:(id)arg2 repository:(id)arg3 query:(id)arg4 pagination:(CDUnknownBlockType)arg5 reply:(CDUnknownBlockType)arg6;
- (void)repositoryBranches:(id)arg1 account:(id)arg2 repository:(id)arg3 includeUpstream:(BOOL)arg4 reply:(CDUnknownBlockType)arg5;
- (void)updateRepositoryPermissions:(id)arg1 account:(id)arg2 repository:(id)arg3 reply:(CDUnknownBlockType)arg4;
- (void)mergePullRequest:(id)arg1 account:(id)arg2 pullRequest:(id)arg3 action:(id)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)deleteComment:(id)arg1 comment:(id)arg2 pullRequest:(id)arg3 account:(id)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)updateComment:(id)arg1 comment:(id)arg2 pullRequest:(id)arg3 account:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)createComment:(id)arg1 comment:(id)arg2 pullRequest:(id)arg3 account:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)createFileDiscussion:(id)arg1 discussion:(id)arg2 pullRequest:(id)arg3 account:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)uploadPullRequestAttachments:(id)arg1 account:(id)arg2 repository:(id)arg3 fileURLs:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)updatePullRequest:(id)arg1 account:(id)arg2 pullRequest:(id)arg3 targetBranch:(id)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)branch:(id)arg1 account:(id)arg2 repositoryURL:(id)arg3 branchName:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)pullRequestMergabilityInformation:(id)arg1 account:(id)arg2 pullRequest:(id)arg3 reply:(CDUnknownBlockType)arg4;
...
- (void)avatar:(id)arg1 account:(id)arg2 email:(id)arg3 username:(id)arg4 url:(id)arg5 size:(unsigned int)arg6 reply:(CDUnknownBlockType)arg7;
...
- (void)removeBranchesPaginationBlockForUUID:(id)arg1;
- (CDUnknownBlockType)branchesPaginationBlockForUUID:(id)arg1;
- (void)addBranchesPaginationBlock:(CDUnknownBlockType)arg1 forUUID:(id)arg2;
