...
- (void)worker:(id <IDETestRunner>)arg1 forTestTargetRunner:(id <IDETestTargetRunner>)arg2 testSuiteDidFinishWithRunCount:(unsigned long long)arg3 skipCount:(unsigned long long)arg4 failureCount:(unsigned long long)arg5 unexpectedFailureCount:(unsigned long long)arg6 testDuration:(double)arg7 totalDuration:(double)arg8 rawOutput:(NSString *)arg9;
