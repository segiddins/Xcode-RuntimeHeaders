...
@class DVTDelayedInvocation, DVTStackBacktrace, IDEManageCertificatesContext, IDEManageCertificatesItemCollection, NSError, NSSet, NSString;
@protocol DVTInvalidation, DVTPortalCertificateProtocol, OS_dispatch_queue;
...
@interface IDEManageCertificatesItemSource : NSObject <DVTInvalidation>
{
    ...
    id <DVTPortalCertificateProtocol> _newlyCreatedCertificate;
}
