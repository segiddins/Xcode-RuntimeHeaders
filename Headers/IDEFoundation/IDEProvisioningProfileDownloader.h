...
@class DVTDelayedInvocation, DVTLogAspect, DVTObservingToken, DVTPerformanceMetric, DVTSemaphore, DVTStackBacktrace, IDEProvisioningCompoundProfileStore, IDEProvisioningProfileDownloaderContext, NSArray, NSDictionary, NSError, NSMutableArray, NSOperationQueue, NSSet, NSString;
