...
- (BOOL)_uploadSensorReplayDataWithPath:(id)arg1 forInstalledApplicationWithBundleIdentifier:(id)arg2 error:(id *)arg3;
...
- (BOOL)_stageAndUploadSensorReplayFileToApplication:(id)arg1 launchSession:(id)arg2 outError:(id *)arg3;
...
- (id)_testingFrameworkPathWithError:(id *)arg1;
- (BOOL)_overriddenPathFromEnvironmentVariableNamed:(id)arg1 path:(id *)arg2 error:(id *)arg3;
- (id)_pathToPlatformDeveloperAppleInternalLibrarySubpath:(id)arg1;
- (id)_pathToPlatformDeveloperLibrarySubpath:(id)arg1 error:(id *)arg2;
...
- (id)_executeDeveloperServicesHealthCheckCommandWithServicesNotRunningNotificationBlock:(CDUnknownBlockType)arg1;
- (id)_executeLoadDeveloperServicesCommand;
