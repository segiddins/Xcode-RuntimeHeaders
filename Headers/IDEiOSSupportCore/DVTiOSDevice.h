...
@class DTDKRemoteDeviceToken, DTXChannel, DVTFuture, DVTNotificationToken, DVTObservingToken, IDELaunchParametersSnapshot, NSError, NSMutableSet, NSObject, NSSet, NSString;
...
- (id)_updatedTestingEnvironmentVariables:(id)arg1 forApplication:(id)arg2 error:(id *)arg3;
