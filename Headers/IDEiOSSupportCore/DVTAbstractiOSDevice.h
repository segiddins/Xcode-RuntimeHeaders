...
- (void)simulateMetricPayloadsWithBundleID:(id)arg1 payload:(id)arg2 onProxy:(BOOL)arg3 completed:(CDUnknownBlockType)arg4;
...
- (BOOL)updateInstalledApplicationsWithMobileInstallRebuild:(BOOL)arg1 error:(id *)arg2;
- (BOOL)updateInstalledApplicationsWithError:(id *)arg1;
- (BOOL)copyLocalPath:(id)arg1 toLocalPath:(id)arg2 sync:(BOOL)arg3 error:(id *)arg4;
- (BOOL)copyDevicePath:(id)arg1 toLocalPath:(id)arg2 sync:(BOOL)arg3 error:(id *)arg4;
- (BOOL)copyLocalPath:(id)arg1 toDevicePath:(id)arg2 sync:(BOOL)arg3 error:(id *)arg4;
- (BOOL)copyDevicePath:(id)arg1 toDevicePath:(id)arg2 sync:(BOOL)arg3 error:(id *)arg4;
...
- (id)_rsyncInstallSourcePath:(id)arg1 destinationPath:(id)arg2 entirelyOnDevice:(BOOL)arg3 sync:(BOOL)arg4 activityString:(id)arg5 retryCount:(unsigned long long)arg6 deviceOperation:(id)arg7 error:(id *)arg8;
- (id)_rsyncInstallDevicePath:(id)arg1 toDevicePath:(id)arg2 sync:(_Bool)arg3 activityString:(id)arg4 deviceOperation:(id)arg5 error:(id *)arg6;
- (id)_rsyncInstallLocalPath:(id)arg1 toDevicePath:(id)arg2 sync:(_Bool)arg3 activityString:(id)arg4 deviceOperation:(id)arg5 error:(id *)arg6;
...
- (BOOL)_killProcessesForProductInstallWithWorkspace:(id)arg1 killProcesses:(id)arg2 error:(id *)arg3;
...
- (void)_gatherRootPropertiesForProductInstallWithWorkspace:(id)arg1 buildables:(id)arg2 buildParameters:(id)arg3 filePath:(id)arg4 outSourcePath:(id *)arg5 outInstallPath:(id *)arg6 outAdditionalPaths:(id *)arg7 outHardLinkDirs:(id *)arg8 outAnyAppsInstalledToStagingPath:(char *)arg9 outAnyAppsInstalledToNonStagingPaths:(char *)arg10 outInstallUUID:(id *)arg11 outDisableMobileInstallRebuild:(char *)arg12;
...
- (BOOL)multiLineCommand:(id)arg1 onDevice:(BOOL)arg2 stdOutResult:(id *)arg3 error:(id *)arg4;
- (BOOL)oneLineCommand:(id)arg1 onDevice:(BOOL)arg2 withArguments:(id)arg3 environment:(id)arg4 stdOutResult:(id *)arg5 error:(id *)arg6;
