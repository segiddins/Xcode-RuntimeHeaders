...
@class DVTNotificationToken, DVTReplacementView, IDEDocContentAreaViewController, NSArray, NSDocument, NSMenu, NSString, NSURL;

@interface IDEDocDocumentationTabViewController : DVTViewController <DVTReplacementViewDelegate, NSSharingServiceDelegate>
{
    DVTNotificationToken *_titleNotificationObservationToken;
