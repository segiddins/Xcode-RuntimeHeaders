...
@class DVTPerformanceMetric, DVTScopeBarView, DVTTableView, IDEDocSearchQuery, IDEReferenceDocumentationInfo, NSArray, NSDictionary, NSStackView, NSString, NSTrackingArea;
...
@interface IDEDocSearchResultsWindowController : NSWindowController <NSTableViewDataSource, NSTableViewDelegate>
{
    ...
    NSDictionary *_tableCellViewHeightValueForResultItemIdentifier;
...
- (CDUnknownBlockType)heightCalculatorForRowWithCellIdentifier:(id)arg1;
- (CDUnknownBlockType)fixedHeightForRowWithCellIdentifier:(id)arg1;
- (void)windowDidLoad;
