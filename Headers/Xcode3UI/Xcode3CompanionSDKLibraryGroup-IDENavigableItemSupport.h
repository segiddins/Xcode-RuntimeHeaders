...
#import <DevToolsCore/Xcode3CompanionSDKLibraryGroup.h>
...
@interface Xcode3CompanionSDKLibraryGroup (IDENavigableItemSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
