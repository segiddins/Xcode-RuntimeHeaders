...
#import <DevToolsCore/Xcode3LibraryPackageProductReference.h>
...
@interface Xcode3LibraryPackageProductReference (IDENavigableItemSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
