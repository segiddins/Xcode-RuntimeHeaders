...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, NSArray, NSImage, NSNull, NSString, NSURL, PBXReference, _TtC13DVTFoundation9DVTSymbol;

@interface Xcode3DevelopmentAssetsPath : DVTModelTreeNode <IDEKeyDrivenNavigableItemRepresentedObject>
{
...
@property(readonly, copy) NSString *absolutePath;
- (id)initWithReference:(id)arg1 rawProjectRelativePath:(id)arg2;
