...
#import <DevToolsCore/Xcode3LibraryPackageProductGroup.h>
...
@interface Xcode3LibraryPackageProductGroup (IDENavigableItemSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
