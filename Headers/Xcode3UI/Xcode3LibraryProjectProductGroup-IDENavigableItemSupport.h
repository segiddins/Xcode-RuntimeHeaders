...
#import <DevToolsCore/Xcode3LibraryProjectProductGroup.h>
...
@interface Xcode3LibraryProjectProductGroup (IDENavigableItemSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
