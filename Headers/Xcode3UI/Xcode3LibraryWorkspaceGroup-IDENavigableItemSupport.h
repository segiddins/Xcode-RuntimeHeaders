...
#import <DevToolsCore/Xcode3LibraryWorkspaceGroup.h>
...
@interface Xcode3LibraryWorkspaceGroup (IDENavigableItemSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
