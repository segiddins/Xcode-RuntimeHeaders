...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, NSArray, NSImage, NSMutableArray, NSMutableSet, NSNull, NSString, NSURL, Xcode3BuildPhase, _TtC13DVTFoundation9DVTSymbol;

@interface Xcode3BuildFileGroup : DVTModelTreeNode <IDEKeyDrivenNavigableItemRepresentedObject>
{
    NSString *_name;
    NSMutableSet *_packageReferencesToRemove;
}
...
- (void)clearPackageReferencesToRemove;
- (void)addPackageReferenceToRemove:(id)arg1;
