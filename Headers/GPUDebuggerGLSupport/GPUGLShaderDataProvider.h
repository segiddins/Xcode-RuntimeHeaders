...
@class DYGLProgramObject, GPUTraceShaderDataItem, GPUTraceShaderItem, IDEEditorDocument, IDEIndex, NSDictionary, NSMutableArray, NSString, NSURL;
@protocol DYPShaderSourceDocument, DYResource, GPUTraceShaderDataProviderDelegate;
...
@interface GPUGLShaderDataProvider : NSObject <GPUTraceShaderDataProvider>
{
    ...
    DYGLProgramObject *_programObject;
