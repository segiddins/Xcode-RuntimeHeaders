...
- (id)_addObjectToParent:(id)arg1 objectID:(unsigned int)arg2 objectInternalID:(unsigned int)arg3 target:(unsigned int)arg4 attachment:(int)arg5 indexType:(unsigned int)arg6 context:(const ContextStateMirror_e2d92de6 *)arg7 prefix:(const char *)arg8 annotations:(id)arg9;
...
- (id)_createGPUTraceResourceItemWithParent:(id)arg1 object:(const void *)arg2 objectID:(unsigned int)arg3 labelTarget:(unsigned int)arg4 context:(const ContextStateMirror_e2d92de6 *)arg5 prefix:(const char *)arg6 type:(unsigned int)arg7;
...
- (id)_identifierForObject:(unsigned long long)arg1 context:(const ContextStateMirror_e2d92de6 *)arg2 target:(unsigned int)arg3 prefix:(const char *)arg4 suffix:(const char *)arg5;
...
@property(readonly, nonatomic) StateMirrorManager_912556b7 *manager;
