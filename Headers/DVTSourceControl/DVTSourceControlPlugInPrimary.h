...
- (void)cherryPick:(id)arg1 revision:(id)arg2 parentRevision:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (void)currentConflictRevisionsForWorkingCopy:(id)arg1 upstreamRevision:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
