...
- (void)historyOfWorkingCopy:(id)arg1 fromRevision:(id)arg2 toRevision:(id)arg3 inclusionType:(unsigned long long)arg4 maximumLogItems:(long long)arg5 searchString:(id)arg6 searchType:(unsigned long long)arg7 includeFilePaths:(BOOL)arg8 progressIdentifier:(id)arg9 completionBlock:(CDUnknownBlockType)arg10;
...
- (void)historyOfFileWithNameStatus:(id)arg1 inWorkingCopy:(id)arg2 fromRevisionLocation:(id)arg3 maxLogItems:(long long)arg4 completionBlock:(CDUnknownBlockType)arg5;
- (void)commitDetailsWithParents:(id)arg1 forRevision:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)historyOfFile:(id)arg1 inWorkingCopy:(id)arg2 searchString:(id)arg3 searchType:(unsigned long long)arg4 progressIdentifier:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
