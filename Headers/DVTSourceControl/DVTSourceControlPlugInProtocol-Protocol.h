...
- (void)historyOfFileWithNameStatus:(NSString *)arg1 inWorkingCopy:(DVTSourceControlWorkingCopy *)arg2 fromRevisionLocation:(DVTSourceControlRevisionLocation *)arg3 maxLogItems:(long long)arg4 completionBlock:(void (^)(NSArray *, NSError *))arg5;
- (void)historyOfFile:(NSString *)arg1 inWorkingCopy:(DVTSourceControlWorkingCopy *)arg2 searchString:(NSString *)arg3 searchType:(unsigned long long)arg4 progressIdentifier:(NSString *)arg5 completionBlock:(void (^)(NSArray *, NSError *))arg6;
- (void)commitDetailsWithParents:(DVTSourceControlWorkingCopy *)arg1 forRevision:(DVTSourceControlRevision *)arg2 completionBlock:(void (^)(DVTSourceControlLogItem *, NSArray *, NSDictionary *, NSError *))arg3;
