...
- (void)applyStashInWorkingCopy:(DVTSourceControlWorkingCopy *)arg1 stash:(DVTSourceControlStash *)arg2 completionBlock:(void (^)(BOOL, NSError *))arg3;
...
- (void)listBranchesOfRepository:(DVTSourceControlRepository *)arg1 completionBlock:(void (^)(NSArray *, DVTSourceControlBranch *, NSError *))arg2;
...
- (void)headRevisionOfRepository:(DVTSourceControlRepository *)arg1 completionBlock:(void (^)(DVTSourceControlRevision *, DVTSourceControlBranch *, NSError *))arg2;
...
- (void)logItemWithParentsForIdentifier:(NSString *)arg1 ofWorkingCopy:(DVTSourceControlWorkingCopy *)arg2 completionBlock:(void (^)(DVTSourceControlVisualLogItem *, NSArray *, NSError *))arg3;
...
- (void)currentConflictRevisionsForWorkingCopy:(DVTSourceControlWorkingCopy *)arg1 upstreamRevision:(DVTSourceControlRevision *)arg2 completionBlock:(void (^)(DVTSourceControlRevision *, DVTSourceControlRevision *, DVTSourceControlRevision *, NSError *))arg3;
...
- (void)historyOfFile:(NSString *)arg1 inWorkingCopy:(DVTSourceControlWorkingCopy *)arg2 fromRevisionLocation:(DVTSourceControlRevisionLocation *)arg3 showMergeCommits:(BOOL)arg4 maxLogItems:(long long)arg5 progressIdentifier:(NSString *)arg6 completionBlock:(void (^)(NSArray *, NSError *))arg7;
...
- (void)allCurrentLocations:(DVTSourceControlWorkingCopy *)arg1 completionBlock:(void (^)(NSArray *, NSArray *, NSDictionary *, NSDictionary *, NSArray *, DVTSourceControlRevisionLocation *, unsigned long long, DVTSourceControlRemoteRepository *, NSError *))arg2;
...
- (void)cherryPick:(DVTSourceControlWorkingCopy *)arg1 revision:(DVTSourceControlRevision *)arg2 parentRevision:(DVTSourceControlRevision *)arg3 completionBlock:(void (^)(DVTSourceControlRevision *, BOOL, NSError *))arg4;
...
- (void)defaultAuthorForWorkingCopy:(DVTSourceControlWorkingCopy *)arg1 completionBlock:(void (^)(DVTSourceControlAuthor *, NSError *))arg2;
