...
#import <DVTSourceControl/DVTSourceControlLogItemProtocol-Protocol.h>
...
@interface DVTSourceControlVisualLogItem : NSObject <NSSecureCoding, NSCopying, DVTSourceControlLogItemProtocol>
{
    BOOL _complete;
...
- (id)initIncompleteLogItemWithAuthor:(id)arg1 revision:(id)arg2 date:(id)arg3 message:(id)arg4 revisionType:(unsigned long long)arg5;
