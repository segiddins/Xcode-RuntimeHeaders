...
@interface _TtC12SourceEditor25SourceEditorLayoutManager : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: effectController
    ...
    // Error parsing type: , name: _defaultLineHeight
    ...
    // Error parsing type: , name: _defaultAccessibilityStringAttributes
    // Error parsing type: , name: currentLayoutPassBoundsWidth
    // Error parsing type: , name: $__lazy_storage_$_lineSpacing
    ...
    // Error parsing type: , name: columnShiftCompensationEffect
    ...
    // Error parsing type: , name: hiddenTextOverrideProviders
    ...
    // Error parsing type: , name: $__lazy_storage_$_dataSourceObserver
    // Error parsing type: , name: $__lazy_storage_$_identifier
    // Error parsing type: , name: isAdjustingViewport
    // Error parsing type: , name: hasPreviouslyAttachedAuxiliaryView
    // Error parsing type: , name: hasPreviouslyAttachedSubstitutionView
}
