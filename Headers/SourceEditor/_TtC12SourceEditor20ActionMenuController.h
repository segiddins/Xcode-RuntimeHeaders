...
@interface _TtC12SourceEditor20ActionMenuController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate, NSPopoverDelegate>
{
    ...
    // Error parsing type: , name: filterFieldTopConstraint
    // Error parsing type: , name: filterFieldHeightConstraint
    ...
    // Error parsing type: , name: shouldAnimationPopoverSizeChanges
