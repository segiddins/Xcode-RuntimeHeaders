...
- (BOOL)_populateIssues:(id)arg1 forARImageSet:(id)arg2 withQuality:(struct ODTQualityEstimate *)arg3 andSiblings:(id)arg4;
- (void)_populateDuplicateChildIssues:(id)arg1 forChild:(id)arg2 withQuality:(struct ODTQualityEstimate *)arg3 andSiblings:(id)arg4;
