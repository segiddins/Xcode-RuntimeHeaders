...
- (void).cxx_destruct;
- (id)description;
- (id)outputToFilePath:(id)arg1 withDefinitions:(id)arg2 indentString:(id)arg3 rootGroup:(id)arg4 targets:(id)arg5 basedOn:(id)arg6 targetName:(id)arg7 suppressTargetGroup:(BOOL)arg8 error:(id *)arg9 replacementHandler:(CDUnknownBlockType)arg10;
