...
@class CDMFetchIndex, CDMModel, CDMProperty, DVTDocumentLocation, DVTFileDataType, DVTStackBacktrace, DVTSymbol, IDEFileReference, NSArray, NSExpression, NSImage, NSMutableDictionary, NSNull, NSNumber, NSString, NSURL, NSUndoManager;
