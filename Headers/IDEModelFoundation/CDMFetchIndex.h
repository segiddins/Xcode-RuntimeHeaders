...
@class CDMEntity, CDMModel, CDMProperty, DVTDocumentLocation, DVTFileDataType, DVTStackBacktrace, DVTSymbol, IDEFileReference, NSArray, NSImage, NSMutableArray, NSNull, NSNumber, NSPredicate, NSString, NSURL, NSUndoManager;
