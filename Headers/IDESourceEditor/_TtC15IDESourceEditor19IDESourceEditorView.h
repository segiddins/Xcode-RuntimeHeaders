...
@class DVTSourceCodeLanguage, DVTTextCompletionController, DVTTextCompletionDataSource, MISSING_TYPE, NSScrollView, NSString;
...
{
    MISSING_TYPE *completionController;
    MISSING_TYPE *realCompletionsDataSource;
    MISSING_TYPE *isCurrentlyDoingNonUserEditing;
    MISSING_TYPE *workspaceWindowKeyViewLoopNotificationToken;
    MISSING_TYPE *sharedFindStringNotificationToken;
    MISSING_TYPE *sharedReplaceStringNotificationToken;
    MISSING_TYPE *sharedFindOptionsNotificationToken;
    MISSING_TYPE *isPushingFindConfiguration;
    MISSING_TYPE *isPullingFindConfiguration;
    MISSING_TYPE *minimapBreakpointsGutter;
    MISSING_TYPE *$__lazy_storage_$_updateMinimapBreakpointsGutterContinuation;
    MISSING_TYPE *markedVerticalScroller;
    MISSING_TYPE *$__lazy_storage_$_updateMarkedVerticalScrollerContinuation;
}
