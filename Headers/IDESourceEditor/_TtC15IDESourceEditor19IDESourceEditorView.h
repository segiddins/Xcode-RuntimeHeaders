...
@interface _TtC15IDESourceEditor19IDESourceEditorView : _$s15DVTSourceEditor0aB4ViewCN <DVTSourceEditorViewProtocol, DVTTextCompletionSupportingTextView, DVTMarkedScrollerDelegate>
{
    ...
    // Error parsing type: , name: minimapBreakpointsGutter
    // Error parsing type: , name: $__lazy_storage_$_updateMinimapBreakpointsGutterContinuation
    // Error parsing type: , name: markedVerticalScroller
    // Error parsing type: , name: $__lazy_storage_$_updateMarkedVerticalScrollerContinuation
}
