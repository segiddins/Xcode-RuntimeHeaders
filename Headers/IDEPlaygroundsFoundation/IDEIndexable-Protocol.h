...
#import <IDEPlaygroundsFoundation/NSCopying-Protocol.h>
#import <IDEPlaygroundsFoundation/NSObject-Protocol.h>

@class DVTFilePath, IDEContainer, IDERefactoringBuildSettings, IDEWorkspace, NSArray, NSDictionary, NSMutableSet, NSSet, NSString, OS_dispatch_queue;
...
@optional
@property(nonatomic, readonly) NSSet *supportedPlatformsForIndexing;
- (BOOL)isUnitTest;
