...
#import <IDEITunesSoftwareServiceFoundation/ITunesSoftwareServiceUploadDelegate-Protocol.h>

@class DVTLogAspect, NSString;

@interface IDEITunesConnectProxyDelegate : NSObject <ITunesSoftwareServiceUploadDelegate>
{
