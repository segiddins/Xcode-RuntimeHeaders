...
-     // Error parsing type: v88@0:8{?=f}16{?=[3]}32@80, name: getObjectsInCircle:transformedBy:result:
- (void)getObjectsInCircle:(CDStruct_37a3040a)arg1 result:(id)arg2;
-     // Error parsing type: v88@0:8{?=}16{?=[3]}32@80, name: getObjectsInBox:transformedBy:result:
...
- (CDStruct_37a3040a)getBoundingCircleOfObject:(long long)arg1;
- (struct)getBoundingBoxOfObject:(long long)arg1;
- (void)setObject:(long long)arg1 withBoundingCircle:(CDStruct_37a3040a)arg2;
- (void)setObject:(long long)arg1 withBoundingBox:(struct)arg2;
- (BOOL)isObjectValid:(long long)arg1;
@property(readonly) struct quadtreeBoundingBox;
