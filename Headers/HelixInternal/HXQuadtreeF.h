...
{
    struct DefaultAccessorQuadtree m_octStruct;
}
...
- (void)getObjectsInCircle:(CDStruct_37a3040a)arg1 transformedBy:(CDStruct_d80e62f2)arg2 result:(id)arg3;
- (void)getObjectsInCircle:(CDStruct_37a3040a)arg1 result:(id)arg2;
- (void)getObjectsInBox:(struct)arg1 transformedBy:(CDStruct_d80e62f2)arg2 result:(id)arg3;
