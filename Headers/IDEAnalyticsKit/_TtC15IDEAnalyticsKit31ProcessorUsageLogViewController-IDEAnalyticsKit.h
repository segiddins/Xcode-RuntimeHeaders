...
#import <IDEAnalyticsKit/_TtC15IDEAnalyticsKit31ProcessorUsageLogViewController.h>

@interface _TtC15IDEAnalyticsKit31ProcessorUsageLogViewController (IDEAnalyticsKit)
