...
@class DVTCrashLogStackFrame, IDECrashLogViewController, NSButton, NSImageView, NSTextField;

@interface IDECrashLogBacktraceTableCellView : NSTableCellView
{
    ...
    IDECrashLogViewController *_crashLogViewController;
}

- (void).cxx_destruct;
@property(nonatomic) __weak IDECrashLogViewController *crashLogViewController; // @synthesize crashLogViewController=_crashLogViewController;
