...
#import <IDEAnalyticsKit/DVTStructuredLayoutView-Protocol.h>

@class DVTStructuredLayoutViewState, NSArray, NSAttributedString, NSDictionary, NSImage, NSImageView, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSValue, NSView, _IDEAnalyticsKitTableCellViewTextField;
@protocol IDEAnalyticsKitTableCellViewTitleEditingDelegate;

@interface IDEAnalyticsKitTableCellView : NSTableCellView <DVTStructuredLayoutView>
{
    ...
    _IDEAnalyticsKitTableCellViewTextField *_prioritizedTextField;
    _IDEAnalyticsKitTableCellViewTextField *_deprioritizedTextField;
    BOOL _subviewOrderIsValid;
    BOOL _usesGroupHeaderStyle;
    DVTStructuredLayoutViewState *_dvt_layoutState;
    id <IDEAnalyticsKitTableCellViewTitleEditingDelegate> _titleEditingDelegate;
    ...
    _IDEAnalyticsKitTableCellViewTextField *_titleTextField;
    _IDEAnalyticsKitTableCellViewTextField *_subtitleTextField;
}

+ (double)imageSizeForRowSizeStyle:(long long)arg1;
...
+ (void)initialize;
- (void).cxx_destruct;
@property(retain) _IDEAnalyticsKitTableCellViewTextField *subtitleTextField; // @synthesize subtitleTextField=_subtitleTextField;
@property(retain) _IDEAnalyticsKitTableCellViewTextField *titleTextField; // @synthesize titleTextField=_titleTextField;
...
@property __weak id <IDEAnalyticsKitTableCellViewTitleEditingDelegate> titleEditingDelegate; // @synthesize titleEditingDelegate=_titleEditingDelegate;
