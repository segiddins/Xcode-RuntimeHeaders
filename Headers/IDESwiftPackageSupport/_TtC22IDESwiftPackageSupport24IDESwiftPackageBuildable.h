...
@class DVTFileDataType, DVTFilePath, IDEEntityIdentifier, NSDictionary, NSSet, NSString;
...
@interface _TtC22IDESwiftPackageSupport24IDESwiftPackageBuildable : DVTInvalidation_NSObject <IDEBuildableProduct>
{
    ...
    // Error parsing type: , name: entityIdentifier
    // Error parsing type: , name: cachedMacroExpansionScopes
}
