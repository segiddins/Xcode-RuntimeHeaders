...
@class MISSING_TYPE, NSButton, NSLayoutConstraint, NSStackView, NSTextField, _TtC6IDEKit18TrainyardTrackView, _TtC6IDEKit19TrainyardLabelField, _TtC6IDEKit32IDESourceControlMessageFieldView;
...
@interface _TtC6IDEKit22TrainyardTableCellView : NSTableCellView <NSStackViewDelegate>
{
    ...
    MISSING_TYPE *$__lazy_storage_$_trainyardEnabled;
    MISSING_TYPE *leadingConstraintConstantWithoutTrainyard;
    MISSING_TYPE *leadingConstraintConstantWithTrainyard;
    MISSING_TYPE *authorImageToken;
    MISSING_TYPE *isTrainyardViewHidden;
}
