...
+ (void)presentDisambiguationUIForSelectingSchemeAndTestPlanForRunningTestCollection:(id)arg1 workspaceTabController:(id)arg2 contextString:(id)arg3;
+ (void)runTestCollectionContainedWithinActiveTestPlan:(id)arg1 testPlanConfigurations:(id)arg2 forWorkspaceTabController:(id)arg3 contextString:(id)arg4;
...
+ (void)_validateMenuItem:(id)arg1 forTestCollection:(id)arg2 testPlan:(id)arg3 inWorkspace:(id)arg4;
