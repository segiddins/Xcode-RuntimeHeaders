...
@class DVTObservingToken, DVTStackBacktrace, IDENavigableItem, IDENavigableItemAsyncFilteringCoordinator, IDENavigatorDataCell, IDENavigatorOutlineView, IDEWorkspace, NSArray, NSButtonCell, NSMutableSet, NSPredicate, NSScrollView, NSSearchField, NSString, NSTextFieldCell;
@protocol IDEBatchFindLocationPickerViewDelegate;
