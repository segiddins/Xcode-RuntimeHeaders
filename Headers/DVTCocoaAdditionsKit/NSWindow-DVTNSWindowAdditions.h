...
- (void)dvt_closeWindowAsWindowTab:(id)arg1;
- (void)dvt_performCloseWindow:(id)arg1;
- (void)dvt_setTrafficLightButtonsVisible:(BOOL)arg1;
...
- (id)dvt_registerContentLayoutRectObserver:(id)arg1;
- (id)dvt_windowContentLayoutRectNotifier;
