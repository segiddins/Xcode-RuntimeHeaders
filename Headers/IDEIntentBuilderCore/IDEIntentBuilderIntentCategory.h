...
@class IDEIntentBuilderIntentCategoryVerb, NSString;
...
@interface IDEIntentBuilderIntentCategory : NSObject <NSCopying>
{
    ...
    NSString *_name;
    NSString *_title;
    IDEIntentBuilderIntentCategoryVerb *_verb;
...
@property(copy, nonatomic, setter=_setVerb:) IDEIntentBuilderIntentCategoryVerb *verb; // @synthesize verb=_verb;
