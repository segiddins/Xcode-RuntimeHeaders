...
@class DVTScopeBarsManager, DVTStackView_ML, IDESchemeActionsInvocationRecord, NSArray, NSMenuItem, NSMutableArray, NSOperationQueue, NSScrollView, NSString, NSTextView, NSView, XCSBot, XCSBotSupportingEditor, XCSIntegration, XCSUIBotLogScopeBar, XCSUIProgressViewController;
