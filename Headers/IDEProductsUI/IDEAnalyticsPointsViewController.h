...
@class DVTObservingToken, DVTReplacementView, DVTSplitView, IDEAnalyticsPointDetailViewController, IDEAnalyticsPointSourceListViewController, IDELaunchSession, IDEOpenInProjectSheetController, IDEProductsEmptyContentViewController, NSString;
