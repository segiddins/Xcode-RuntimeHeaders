...
#import <IDESpriteKitParticleEditor/EditOverlayDelegate-Protocol.h>
...
@class DVTBorderedView, DVTGradientImageButton, DVTObservingToken, DVTReplacementView, DVTStepperTextField, EditOverlayView, GTFActionEditor, GTFActionLibrary, NSArray, NSButton, NSImage, NSMutableDictionary, NSString, NSTextField, SKEditView, SKEditingSceneTarget, SKSceneDocumentBorderedView, SKSceneDocumentScopeBarView, SKSceneDocumentSplitView;
@protocol NSObject;
...
- (void)editOverlay:(id)arg1 manipulationEnded:(id)arg2 property:(long long)arg3;
- (void)editOverlay:(id)arg1 manipulationBegan:(id)arg2 property:(long long)arg3;
...
- (void)actionEditorDidEndScrubbing:(id)arg1;
- (void)actionEditorDidBeginScrubbing:(id)arg1;
