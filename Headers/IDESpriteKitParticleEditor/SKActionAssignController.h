...
#import <IDESpriteKitParticleEditor/NSTableViewDataSource-Protocol.h>

@class DVTBorderedView, DVTStackBacktrace, NSArray, NSArrayController, NSMutableSet, NSScrollView, NSString, SKActionAssignTableView;
@protocol SKActionAssignControllerDelegate;
