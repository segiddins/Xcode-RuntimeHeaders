...
- (BOOL)_nodeHasFilteredChild:(id)arg1;
- (BOOL)_nodeHasFilteredParent:(id)arg1;
- (BOOL)_isNodeFiltered:(id)arg1;
- (void)_filterNodes;
...
- (void)sceneDocument:(id)arg1 didMoveChildNode:(id)arg2 toIndex:(unsigned long long)arg3;
- (void)sceneDocument:(id)arg1 didMoveNode:(id)arg2 toParentNode:(id)arg3;
