...
#import <IDESpriteKitParticleEditor/SKEditingTarget-Protocol.h>

@class DVTObservingToken, GTFActionLibrary, NSArray, NSMutableArray, NSString, SKActionEditorNavigableRepresentedNode, SKDocument;
