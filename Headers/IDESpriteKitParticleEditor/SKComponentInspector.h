...
@class DVTNotificationToken, DVTObservingToken, GKComponent, SKSceneCustomComponent;

@interface SKComponentInspector : IDEInspectorViewController
{
    SKSceneCustomComponent *_inspectedComponent;
