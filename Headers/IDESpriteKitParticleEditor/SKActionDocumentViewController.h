...
@class DVTGradientImageButton, DVTObservingToken, DVTReplacementView, DVTStepperTextField, GTFActionEditor, GTFActionLibrary, NSArrayController, NSMutableDictionary, NSPopUpButton, NSString, NSView, SKActionDocumentBorderedView, SKActionDocumentScopeBarView, SKActionDocumentSplitView, SKActionPreviewViewController, SKDocument, SKEditView, SKEditingActionTarget;
