...
+ (id)integrationWithBot:(id)arg1 shouldClean:(BOOL)arg2 devices:(id)arg3 error:(id *)arg4;
...
- (BOOL)_validateIntegrationWithBot:(id)arg1 testedDevices:(id)arg2 number:(id)arg3 queuedDate:(id)arg4 startedTime:(id)arg5 endedTime:(id)arg6 currentStep:(long long)arg7 result:(long long)arg8 revisionBlueprint:(id)arg9 tags:(id)arg10 testHierarchy:(id)arg11 perfMetricNames:(id)arg12 perfMetricKeyPaths:(id)arg13 anID:(id)arg14 aTinyID:(id)arg15 docType:(id)arg16 error:(id *)arg17;
