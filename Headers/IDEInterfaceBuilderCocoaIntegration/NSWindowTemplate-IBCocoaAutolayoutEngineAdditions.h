...
@interface NSWindowTemplate (IBCocoaAutolayoutEngineAdditions) <IBCocoaCustomObject, NSAppearanceCustomization, IBDocumentArchiving>
...
+ (id)keyPathsForValuesAffectingIbInspectedAutoPositionMask;
