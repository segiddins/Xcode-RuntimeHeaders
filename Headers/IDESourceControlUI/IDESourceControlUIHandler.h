...
#import <IDESourceControlUI/DVTSourceControlAuthenticationFailureHandler-Protocol.h>
...
+ (void)clearFingerprintCompletionBlocks:(BOOL)arg1 host:(id)arg2;
+ (void)clearFingerprintCompletionBlocksForHost:(id)arg1;
+ (id)fingerprintCompletionBlocks;
+ (void)handleCertificateAlert:(id)arg1 URL:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
+ (void)showCertificateAlertOnWindow:(id)arg1 withForce:(BOOL)arg2 URL:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
+ (void)callCertificateListeners:(long long)arg1 fingerprint:(id)arg2 url:(id)arg3;
