...
@class DVTSourceControlHostedAccount, DVTSourceControlSSHKeysAuthenticationStrategy, NSImageView, NSPopUpButton, NSProgressIndicator, NSStackView, NSString, NSTextField, NSView, _TtC18IDESourceControlUI38IDESourceControlSSHKeyWindowController;
...
@interface IDESourceControlSSHKeyCredentialViewController : DVTDealloc2Main_ViewController
{
    ...
    _TtC18IDESourceControlUI38IDESourceControlSSHKeyWindowController *_sshKeyValidationWindowController;
