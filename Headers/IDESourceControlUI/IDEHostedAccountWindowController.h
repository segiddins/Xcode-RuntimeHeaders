...
#import <IDESourceControlUI/AKPinFieldViewDelegate-Protocol.h>
#import <IDESourceControlUI/IDEHostedAccountWindowControllerProtocol-Protocol.h>

@class AKPinFieldView, DVTSourceControlHostedAccount, IDESourceControlHostServiceEndpoint, NSButton, NSDictionary, NSProgressIndicator, NSSecureTextField, NSString, NSTextField, NSURL, NSView, NSWindow;
@protocol DVTCancellable, DVTSourceControlCancellable;

@interface IDEHostedAccountWindowController : NSWindowController <AKPinFieldViewDelegate, IDEHostedAccountWindowControllerProtocol>
{
    ...
    IDESourceControlHostServiceEndpoint *_hostExtensionEndpoint;
