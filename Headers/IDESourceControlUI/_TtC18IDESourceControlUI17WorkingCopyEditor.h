...
@class DVTBorderedView, DVTFilterTokenField, DVTReplacementView, DVTScopeBarButton, NSProgressIndicator, NSScrollView, _TtC18IDESourceControlUI26SourceControlLogItemHolder;
...
@interface _TtC18IDESourceControlUI17WorkingCopyEditor : IDEEditor
{
    ...
    // Error parsing type: , name: searchHandler
