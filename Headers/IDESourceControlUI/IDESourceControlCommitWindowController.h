...
#import <IDESourceControlUI/IDESourceControlReviewFilesWindowController.h>

#import <IDESourceControlUI/IDENavigableItemCoordinatorDelegate-Protocol.h>
#import <IDESourceControlUI/IDESourceControlCommitWindowControllerProtocol-Protocol.h>
#import <IDESourceControlUI/NSTouchBarDelegate-Protocol.h>
#import <IDESourceControlUI/NSTouchBarProvider-Protocol.h>
#import <IDESourceControlUI/_TtP6IDEKit37IDESourceControlAuthenticationContext_-Protocol.h>

@class DVTBorderedView, DVTObservingToken, DVTTextViewWithPlaceholder, IDEComparisonEditorDFRController, IDEEditorDocument, IDESourceControlReviewFilesDataSource, IDESourceControlWorkspaceUIHandler, IDEWorkspace, NSArray, NSButton, NSImageView, NSMutableArray, NSMutableDictionary, NSObject, NSOperationQueue, NSPopUpButton, NSSplitView, NSString, NSTextField, NSTouchBar, _TtC18IDESourceControlUI43IDESourceControlCommitAndPushMenuController;
@protocol DVTSourceControlCancellable, OS_dispatch_queue, OS_dispatch_semaphore;

@interface IDESourceControlCommitWindowController : IDESourceControlReviewFilesWindowController <NSTouchBarProvider, NSTouchBarDelegate, _TtP6IDEKit37IDESourceControlAuthenticationContext_, IDENavigableItemCoordinatorDelegate, IDESourceControlCommitWindowControllerProtocol>
{
