...
@class DVTSourceControlRemoteRepository, IDESourceControlCredentialViewController, NSButton, NSError, NSStackView, NSString, NSTextField, NSWindow, _TtC18IDESourceControlUI44IDESourceControlCredentialAlertWindowContext;
...
@interface IDESourceControlCredentialAlertWindowController : DVTDealloc2Main_WindowController <IDESourceControlCredentialViewDelegate>
{
    ...
    _TtC18IDESourceControlUI44IDESourceControlCredentialAlertWindowContext *_alertWindowContext;
