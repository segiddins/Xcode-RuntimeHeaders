...
@class DTMemoryGraphItem, DTVMUObjectGridGraphViewController, DVTObservingToken, IDEVariablesViewQuickLookPopover, NSArray, NSMutableDictionary, NSProgressIndicator, NSString, NSTextField, NSView, XRMemoryGraphDebuggerRadarManager;
...
- (id)_documentLocationForReferenceName:(id)arg1 withSourceClassName:(id)arg2;
- (id)_documentLocationForClassName:(id)arg1;
...
- (id)_getDebugSessionForRunDestination:(id)arg1;
