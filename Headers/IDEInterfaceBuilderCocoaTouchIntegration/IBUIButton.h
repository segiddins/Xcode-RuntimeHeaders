...
@interface IBUIButton : IBUIControl <IBDocumentArchiving, IBUIFontedObject>
{
    ...
    IBUIButtonStateAttributes *_stateAttributes;
...
+ (BOOL)buttonTypeSupportsCustomPreferredSymbolConfiguration:(long long)arg1;
...
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfigurationFontDescription;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfigurationFontDescription;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfigurationFontDescription;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfigurationFontDescription;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfigurationFontDescription;
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfigurationConfigurationType;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfigurationConfigurationType;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfigurationConfigurationType;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfigurationConfigurationType;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfigurationConfigurationType;
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfigurationScale;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfigurationScale;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfigurationScale;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfigurationScale;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfigurationScale;
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfigurationWeight;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfigurationWeight;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfigurationWeight;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfigurationWeight;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfigurationWeight;
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfigurationPointSize;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfigurationPointSize;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfigurationPointSize;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfigurationPointSize;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfigurationPointSize;
+ (id)keyPathsForValuesAffectingIbInspectedDisabledPreferredSymbolConfiguration;
+ (id)keyPathsForValuesAffectingIbInspectedFocusedPreferredSymbolConfiguration;
+ (id)keyPathsForValuesAffectingIbInspectedSelectedPreferredSymbolConfiguration;
+ (id)keyPathsForValuesAffectingIbInspectedHighlightedPreferredSymbolConfiguration;
+ (id)keyPathsForValuesAffectingIbInspectedNormalPreferredSymbolConfiguration;
...
- (void)clearPreferredSymbolConfigurations;
@property(retain) IBUIImageSymbolConfiguration *disabledPreferredSymbolConfiguration;
@property(retain) IBUIImageSymbolConfiguration *focusedPreferredSymbolConfiguration;
@property(retain) IBUIImageSymbolConfiguration *selectedPreferredSymbolConfiguration;
...
@property(readonly, nonatomic) IBUIButtonStateAttributes *stateAttributes;
...
- (void)setIbInspectedDisabledPreferredSymbolConfigurationFontDescription:(id)arg1;
- (id)ibInspectedDisabledPreferredSymbolConfigurationFontDescription;
- (void)setIbInspectedFocusedPreferredSymbolConfigurationFontDescription:(id)arg1;
- (id)ibInspectedFocusedPreferredSymbolConfigurationFontDescription;
- (void)setIbInspectedSelectedPreferredSymbolConfigurationFontDescription:(id)arg1;
- (id)ibInspectedSelectedPreferredSymbolConfigurationFontDescription;
- (void)setIbInspectedHighlightedPreferredSymbolConfigurationFontDescription:(id)arg1;
- (id)ibInspectedHighlightedPreferredSymbolConfigurationFontDescription;
- (void)setIbInspectedNormalPreferredSymbolConfigurationFontDescription:(id)arg1;
- (id)ibInspectedNormalPreferredSymbolConfigurationFontDescription;
- (void)setIbInspectedDisabledPreferredSymbolConfigurationConfigurationType:(long long)arg1;
- (long long)ibInspectedDisabledPreferredSymbolConfigurationConfigurationType;
- (void)setIbInspectedFocusedPreferredSymbolConfigurationConfigurationType:(long long)arg1;
- (long long)ibInspectedFocusedPreferredSymbolConfigurationConfigurationType;
- (void)setIbInspectedSelectedPreferredSymbolConfigurationConfigurationType:(long long)arg1;
- (long long)ibInspectedSelectedPreferredSymbolConfigurationConfigurationType;
- (void)setIbInspectedHighlightedPreferredSymbolConfigurationConfigurationType:(long long)arg1;
- (long long)ibInspectedHighlightedPreferredSymbolConfigurationConfigurationType;
- (void)setIbInspectedNormalPreferredSymbolConfigurationConfigurationType:(long long)arg1;
- (long long)ibInspectedNormalPreferredSymbolConfigurationConfigurationType;
- (void)setIbInspectedDisabledPreferredSymbolConfigurationScale:(long long)arg1;
- (long long)ibInspectedDisabledPreferredSymbolConfigurationScale;
- (void)setIbInspectedFocusedPreferredSymbolConfigurationScale:(long long)arg1;
- (long long)ibInspectedFocusedPreferredSymbolConfigurationScale;
- (void)setIbInspectedSelectedPreferredSymbolConfigurationScale:(long long)arg1;
- (long long)ibInspectedSelectedPreferredSymbolConfigurationScale;
- (void)setIbInspectedHighlightedPreferredSymbolConfigurationScale:(long long)arg1;
- (long long)ibInspectedHighlightedPreferredSymbolConfigurationScale;
- (void)setIbInspectedNormalPreferredSymbolConfigurationScale:(long long)arg1;
- (long long)ibInspectedNormalPreferredSymbolConfigurationScale;
- (void)setIbInspectedDisabledPreferredSymbolConfigurationWeight:(long long)arg1;
- (long long)ibInspectedDisabledPreferredSymbolConfigurationWeight;
- (void)setIbInspectedFocusedPreferredSymbolConfigurationWeight:(long long)arg1;
- (long long)ibInspectedFocusedPreferredSymbolConfigurationWeight;
- (void)setIbInspectedSelectedPreferredSymbolConfigurationWeight:(long long)arg1;
- (long long)ibInspectedSelectedPreferredSymbolConfigurationWeight;
- (void)setIbInspectedHighlightedPreferredSymbolConfigurationWeight:(long long)arg1;
- (long long)ibInspectedHighlightedPreferredSymbolConfigurationWeight;
- (void)setIbInspectedNormalPreferredSymbolConfigurationWeight:(long long)arg1;
- (long long)ibInspectedNormalPreferredSymbolConfigurationWeight;
- (void)setIbInspectedDisabledPreferredSymbolConfigurationPointSize:(double)arg1;
- (double)ibInspectedDisabledPreferredSymbolConfigurationPointSize;
- (void)setIbInspectedFocusedPreferredSymbolConfigurationPointSize:(double)arg1;
- (double)ibInspectedFocusedPreferredSymbolConfigurationPointSize;
- (void)setIbInspectedSelectedPreferredSymbolConfigurationPointSize:(double)arg1;
- (double)ibInspectedSelectedPreferredSymbolConfigurationPointSize;
- (void)setIbInspectedHighlightedPreferredSymbolConfigurationPointSize:(double)arg1;
- (double)ibInspectedHighlightedPreferredSymbolConfigurationPointSize;
- (void)setIbInspectedNormalPreferredSymbolConfigurationPointSize:(double)arg1;
- (double)ibInspectedNormalPreferredSymbolConfigurationPointSize;
- (void)setIbInspectedDisabledPreferredSymbolConfiguration:(id)arg1;
- (id)ibInspectedDisabledPreferredSymbolConfiguration;
- (void)setIbInspectedFocusedPreferredSymbolConfiguration:(id)arg1;
- (id)ibInspectedFocusedPreferredSymbolConfiguration;
- (void)setIbInspectedSelectedPreferredSymbolConfiguration:(id)arg1;
- (id)ibInspectedSelectedPreferredSymbolConfiguration;
- (void)setIbInspectedHighlightedPreferredSymbolConfiguration:(id)arg1;
- (id)ibInspectedHighlightedPreferredSymbolConfiguration;
- (void)setIbInspectedNormalPreferredSymbolConfiguration:(id)arg1;
- (id)ibInspectedNormalPreferredSymbolConfiguration;
