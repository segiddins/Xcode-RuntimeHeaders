...
@interface IBUIViewController : IBAbstractViewController <IBUISimulatedMetricsIntegratedObject, IBIDEUIViewControllerAutolayoutGuideDelegate, IBDocumentArchiving, IBUISimulatedMetricsObject, IBUIViewControllerAutolayoutGuideDelegate, IBSceneUpdateRequestConfiguring>
{
    ...
    NSNumber *_cachedRequiresClassSwapper;
    NSArray *_cachedChildControllerCreationSelectorNames;
...
+ (id)keyPathsForValuesAffectingIbInspectedRestorationIdentifier;
...
- (void)setIbRequiresClassSwapper:(id)arg1;
- (id)ibRequiresClassSwapper;
- (void)ibInvalidateSegueRelationships;
- (id)childControllerCreationSelectorNames;
...
- (struct CGRect)ibFrameDecisionAdjustedFrameForLayoutFrame:(struct CGRect)arg1 forChild:(id)arg2;
...
- (BOOL)ibIsDownstreamViewController:(id)arg1 depth:(long long)arg2;
