...
@interface IBUIView : IBRemoteView <IBUIInstantiatedView, IBUISimulatedMetricsIntegratedObject, IBIDEUIViewControllerAutolayoutGuideDelegate, IBDocumentArchiving, IBUIViewControllerAutolayoutGuideDelegate, IBUIViewAutolayoutGuideDelegate, IBUISimulatedMetricsObject, IBSceneUpdateRequestConfiguring>
{
    ...
    unsigned long long _designAutoresizingMask;
    long long _isSettingDirectFrame;
...
+ (id)keyPathsForValuesAffectingIbInspectedSimulatedDestinationMetrics;
+ (id)keyPathsForValuesAffectingIbInspectedSimulatedUserInterfaceStyle;
+ (id)keyPathsForValuesAffectingIbInspectedSimulatedBottomBarMetrics;
+ (id)keyPathsForValuesAffectingIbInspectedSimulatedTopBarMetrics;
+ (id)keyPathsForValuesAffectingIbInspectedSimulatedStatusBarMetrics;
...
- (struct IBNSDirectionalEdgeInsets)defaultDirectionalLayoutMargins;
...
- (void)setIbDirectFrameSize:(struct CGSize)arg1;
- (struct CGSize)ibDirectFrameSize;
- (void)setIbDirectFrame:(struct CGRect)arg1;
- (struct CGRect)ibDirectFrame;
- (void)setIbDirectAutoresizingMask:(unsigned long long)arg1;
- (unsigned long long)ibDirectAutoresizingMask;
- (void)setIbDesignFrameSize:(struct CGSize)arg1;
- (struct CGSize)ibDesignFrameSize;
- (void)setFrameSize:(struct CGSize)arg1;
- (void)setFrame:(struct CGRect)arg1;
- (void)setAutoresizingMask:(unsigned long long)arg1;
- (BOOL)ibAutoresizingMaskProcessingDuringComputationStatus;
...
- (void)setIbDesignBounds:(struct CGRect)arg1;
- (struct CGRect)ibDesignBounds;
- (void)setIbDesignFrame:(struct CGRect)arg1;
- (struct CGRect)ibDesignFrame;
