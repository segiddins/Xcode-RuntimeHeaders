...
@interface IBUITableView : IBUIScrollView <IBDocumentArchiving>
{
    ...
    double _ibShadowedEstimatedSectionHeaderHeight;
    double _sectionFooterHeight;
    double _ibShadowedEstimatedSectionFooterHeight;
    NSArray *_sections;
...
+ (id)keyPathsForValuesAffectingIbInspectedDataMode;
...
@property(nonatomic) double ibShadowedEstimatedSectionFooterHeight; // @synthesize ibShadowedEstimatedSectionFooterHeight=_ibShadowedEstimatedSectionFooterHeight;
@property(nonatomic) double sectionFooterHeight; // @synthesize sectionFooterHeight=_sectionFooterHeight;
@property(nonatomic) double ibShadowedEstimatedSectionHeaderHeight; // @synthesize ibShadowedEstimatedSectionHeaderHeight=_ibShadowedEstimatedSectionHeaderHeight;
@property(nonatomic) double sectionHeaderHeight; // @synthesize sectionHeaderHeight=_sectionHeaderHeight;
@property(nonatomic) double ibShadowedEstimatedRowHeight; // @synthesize ibShadowedEstimatedRowHeight=_ibShadowedEstimatedRowHeight;
...
@property(readonly) long long footerTextAlignment;
@property(readonly) long long headerTextAlignment;
...
- (id)ibInspectedStyleNames;
- (id)ibInspectedStyleValues;
- (BOOL)ibSupportsInspectedInsettedGroup;
