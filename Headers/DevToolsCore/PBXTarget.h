...
@interface PBXTarget : PBXProjectItem <XCCompatibilityChecking, XCConfigurationInspectables, XCConfigurationListOwners>
{
    ...
    NSDictionary *_cachedProductSettings;
...
- (void)setStringValue:(id)arg1 forBuildSettingInAllConfigurations:(id)arg2;
...
- (id)absolutePathForProductPart:(long long)arg1;
- (id)resolvedAbsolutePathForProductPart:(long long)arg1;
- (id)subpathForProductPart:(long long)arg1;
...
- (id)buildPhasesContainingReference:(id)arg1;
- (id)embeddedBinaryBuildFiles;
- (void)removeEmbeddedReference:(id)arg1 keepingDependency:(BOOL)arg2 fromBuildPhases:(id)arg3;
- (void)removeEmbeddedReference:(id)arg1 keepingDependency:(BOOL)arg2;
...
- (void)removeEmbeddedPackageProduct:(id)arg1;
- (void)embedPackageProductDependency:(id)arg1 shouldCodesign:(BOOL)arg2;
...
- (id)minimumDeploymentTarget:(id)arg1;
- (id)iconPath;
...
- (void)removeProductSettingForKey:(id)arg1 configuration:(id)arg2;
- (void)setProductSetting:(id)arg1 forKey:(id)arg2;
- (void)setProductSetting:(id)arg1 forKey:(id)arg2 configuration:(id)arg3;
- (id)cachedProductSettingForKey:(id)arg1;
- (void)setProductSettings:(id)arg1;
- (void)setProductSettings:(id)arg1 configuration:(id)arg2;
- (id)productSettings;
- (id)productSettingsForConfiguration:(id)arg1;
- (BOOL)isProductSettingsValid;
- (void)writeProductSettings:(id)arg1 configuration:(id)arg2;
...
- (void)_addNestedProduct:(id)arg1 subfolder:(long long)arg2 subpath:(id)arg3;
