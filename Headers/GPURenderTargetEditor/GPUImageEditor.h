...
@class DVTBorderedView, DYRenderingAttributes, GPUPathControl, GPURenderBufferBezeledLabel, GPURenderBufferView, GPUTraceResourceInfoBubble, NSButton, NSImage, NSLayoutConstraint, NSObject, NSPopUpButton, NSPopover, NSSegmentedControl, NSString, NSTextField, NSView;
