...
@class DVTStackBacktrace, DYRenderingAttributes, GPURenderBufferView, GPURenderJob, GPUTraceEditor, GPUTraceResourceInfoBubble, NSButton, NSLayoutConstraint, NSPopover, NSString, NSTextField;
@protocol DYResource;
