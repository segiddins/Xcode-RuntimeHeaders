...
- (void)_createSwiftRuntimeReportingHelper;
- (void)_createMainThreadCheckerHelper;
- (void)_createUBSanitizerHelper;
- (void)_createThreadSanitizerHelper;
...
- (void)_createAddressSanitizerHelper;
...
- (BOOL)_isExceptionBreakpoint:(id)arg1 thread:(id)arg2 stopReason:(int *)arg3 stopReasonText:(id *)arg4;
- (void)_extractExceptionInfoFrom:(id)arg1 stopReasonText:(id *)arg2;
