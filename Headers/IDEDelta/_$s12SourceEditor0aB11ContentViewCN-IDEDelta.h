...
#import <IDEDelta/DVTSourceCodeComparisonEditorTextView-Protocol.h>

@class NSColor;

@interface _$s12SourceEditor0aB11ContentViewCN (IDEDelta) <DVTSourceCodeComparisonEditorTextView>
