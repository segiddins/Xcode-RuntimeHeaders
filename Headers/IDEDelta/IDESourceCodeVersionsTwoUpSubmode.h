...
#import <IDEDelta/DVTComparisonSplitViewDelegate-Protocol.h>
#import <IDEDelta/DVTDiffSessionDelegate-Protocol.h>
#import <IDEDelta/IDEComparisonEditorDelegate-Protocol.h>
#import <IDEDelta/IDEComparisonEditorSavableMergeState-Protocol.h>
#import <IDEDelta/NSSplitViewDelegate-Protocol.h>

@class DVTBorderedView, DVTComparisonScrollCoordinator, DVTComparisonSplitView, DVTDiffSession, DVTNotificationToken, DVTObservingToken, IDEEditor, IDEEditorDocument, IDESourceCodeVersionsLayoutView, IDESourceControlMergeData, NSDictionary, NSString, _TtC8IDEDelta18TwoUpVisualization;

@interface IDESourceCodeVersionsTwoUpSubmode : IDEComparisonEditorSubmode <IDEComparisonEditorDelegate, NSSplitViewDelegate, DVTDiffSessionDelegate, DVTComparisonSplitViewDelegate, IDEComparisonEditorSavableMergeState>
{
    ...
    _TtC8IDEDelta18TwoUpVisualization *_twoUpVisualization;
    IDEEditorDocument *_mergeDocument;
