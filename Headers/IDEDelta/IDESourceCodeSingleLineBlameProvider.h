...
#import <IDEDelta/DVTInvalidation-Protocol.h>

@class DVTObservingToken, DVTSourceControlWorkingCopy, DVTStackBacktrace, IDESourceCodeBlameController, NSMutableArray, NSString, _TtC8IDEDelta18BlameVisualization;
...
@interface IDESourceCodeSingleLineBlameProvider : NSObject <DVTInvalidation>
{
    ...
    _TtC8IDEDelta18BlameVisualization *_currentBlameVisualization;
}

+ (void)initialize;
- (void).cxx_destruct;
@property BOOL forceReload; // @synthesize forceReload=_forceReload;
@property(retain) _TtC8IDEDelta18BlameVisualization *currentBlameVisualization; // @synthesize currentBlameVisualization=_currentBlameVisualization;
