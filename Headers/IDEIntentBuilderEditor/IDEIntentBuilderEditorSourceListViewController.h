...
@class DVTBorderedView, DVTEmptyContentPlaceholder, DVTGradientImageButton, DVTGradientImagePopUpButton, DVTSearchField, IDEIntentBuilderIndentationAdjustingOutlineView, NSPopover, NSString;
...
@interface IDEIntentBuilderEditorSourceListViewController : IDEIntentBuilderEditorViewController <DVTOutlineViewDelegate, NSOutlineViewDataSource>
{
    ...
    NSPopover *_warningResolutionPopover;
...
- (void)_presentWarningResolutionPopover:(id)arg1 forRow:(long long)arg2;
