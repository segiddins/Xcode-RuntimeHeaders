...
#import <IDEIntentBuilderEditor/IDEIntentBuilderEditorEnumValuesCapsuleViewController.h>
...
@interface IDEIntentBuilderEditorEnumValuesDetailsCapsuleViewController : IDEIntentBuilderEditorEnumValuesCapsuleViewController <NSSplitViewDelegate, NSTableViewDelegate, IDEIntentBuilderComponentStackViewDelegate>
{
...
- (id)_componentViewsForEnumValue:(id)arg1;
- (void)_reloadData;
