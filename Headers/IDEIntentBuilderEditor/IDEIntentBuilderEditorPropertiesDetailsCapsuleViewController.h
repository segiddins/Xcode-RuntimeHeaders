...
#import <IDEIntentBuilderEditor/IDEIntentBuilderEditorPropertiesCapsuleViewController.h>

#import <IDEIntentBuilderEditor/IDEIntentBuilderComponentStackViewDelegate-Protocol.h>
#import <IDEIntentBuilderEditor/IDEIntentBuilderTypeSelectorComponentViewDelegate-Protocol.h>
#import <IDEIntentBuilderEditor/NSSplitViewDelegate-Protocol.h>
#import <IDEIntentBuilderEditor/NSTableViewDelegate-Protocol.h>

@class DVTBorderedView, DVTEmptyContentPlaceholder, DVTObservingToken, DVTSplitView, IDEIntentBuilderComponentStackView, NSString, NSView;

@interface IDEIntentBuilderEditorPropertiesDetailsCapsuleViewController : IDEIntentBuilderEditorPropertiesCapsuleViewController <NSSplitViewDelegate, NSTableViewDelegate, IDEIntentBuilderComponentStackViewDelegate, IDEIntentBuilderTypeSelectorComponentViewDelegate>
{
    DVTObservingToken *_typeObservingToken;
...
- (void)selectPropertyType:(id)arg1 forTypeSelectorComponentView:(id)arg2;
- (void)addTypeForTypeSelectorComponentView:(id)arg1;
- (void)addEnumForTypeSelectorComponentView:(id)arg1;
