...
@interface IDEIntentBuilderEditorContentViewController : IDEIntentBuilderEditorViewController <IDECapsuleListViewDataSource>
{
    ...
    IDEIntentBuilderEditorIntentSiriSuggestionsCapsuleViewController *_intentSuggestionsCapsuleViewController;
...
@property(retain, nonatomic, setter=_setIntentSuggestionsCapsuleViewController:) IDEIntentBuilderEditorIntentSiriSuggestionsCapsuleViewController *_intentSuggestionsCapsuleViewController; // @synthesize _intentSuggestionsCapsuleViewController;
