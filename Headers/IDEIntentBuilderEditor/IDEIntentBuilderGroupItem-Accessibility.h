...
@interface IDEIntentBuilderGroupItem (Accessibility) <IDEKeyDrivenNavigableItemRepresentedObject>
...
- (id)warningResolutionPopoverContentController;
@property(readonly, nonatomic) BOOL hasResolvableWarning;
...
@property(readonly, getter=isSelectableWhenInserted) BOOL selectableWhenInsterted;
