...
@interface DVTGradientImageButtonCell : NSButtonCell
{
    ...
    BOOL _overrideSystemColorForSelection;
    int _gradientStyle;
    unsigned long long _borderSides;
}

@property BOOL overrideSystemColorForSelection; // @synthesize overrideSystemColorForSelection=_overrideSystemColorForSelection;
