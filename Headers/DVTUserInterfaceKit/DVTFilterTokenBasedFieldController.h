...
#import <DVTUserInterfaceKit/DVTFilterTokenFieldCompletionDelegate-Protocol.h>
#import <DVTUserInterfaceKit/DVTFilterTokenFieldDelegate-Protocol.h>

@class DVTFilterTokenField, NSArray, NSData, NSFont, NSMutableArray, NSMutableDictionary, NSSet, NSString, _DVTFilterTokenFieldValue;
...
@property(copy, nonatomic) NSArray *sampleFilterTokens; // @synthesize sampleFilterTokens=_sampleFilterTokens;
...
- (BOOL)restoreFromEncodedState:(id)arg1 error:(id *)arg2;
