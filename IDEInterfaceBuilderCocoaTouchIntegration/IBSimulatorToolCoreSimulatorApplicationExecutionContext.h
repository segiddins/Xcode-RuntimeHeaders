...
#import <IDEInterfaceBuilderCocoaTouchIntegration/IBSimDeviceDebuggingViewControllerDelegate-Protocol.h>

@class IBSimDeviceDebuggingViewController, NSMutableDictionary, NSObject, NSString, NSWindowController;
