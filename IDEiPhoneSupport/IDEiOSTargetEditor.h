...
@class DVTChoice, DVTStackView_ML, IDECapsuleListView, IDECodesigningSettingsViewController, IDETargetEditorSectionViewController, IDEiOSIconsAndLaunchImagesViewController, NSArray, NSBox, NSButton, NSColor, NSComboBox, NSDictionary, NSMutableArray, NSPopUpButton, NSString, NSTextField, NSView, Xcode3CodesignTroubleshootingViewController, Xcode3TargetEditor;
