...
+ (BOOL)addThreadSanitizerEnvironmentVariables:(id)arg1 buildParameters:(id)arg2 buildable:(id)arg3 debugAppExtensions:(BOOL)arg4 debugging:(BOOL)arg5 testing:(BOOL)arg6 error:(id *)arg7;
+ (BOOL)addAddressSanitizerEnvironmentVariables:(id)arg1 buildParameters:(id)arg2 buildable:(id)arg3 debugAppExtensions:(BOOL)arg4 error:(id *)arg5;
+ (BOOL)_addSanitizer:(unsigned long long)arg1 environmentVariables:(id)arg2 buildParameters:(id)arg3 buildable:(id)arg4 debugAppExtensions:(BOOL)arg5 tsanDebugging:(BOOL)arg6 tsanTesting:(BOOL)arg7 error:(id *)arg8;
...
- (id)buildProductToolchainIdentifiersForSchemeCommand:(id)arg1;
...
- (void)modifyEnvironmentForLogging:(id)arg1;
