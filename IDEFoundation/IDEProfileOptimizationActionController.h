...
@class DVTFilePath, IDEBuildParameters, IDEScheme, NSMutableSet, NSString;
...
- (BOOL)mergeOptimizationProfiles:(id)arg1 aggregateFile:(id)arg2 toFileAtPath:(id)arg3 returningError:(id *)arg4;
