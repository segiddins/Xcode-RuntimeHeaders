...
@class DTXConnection, DVTDisallowFinishToken, DVTObservingToken, IDEConsoleAdaptor, NSArray, NSDateFormatter, NSMutableArray, NSMutableDictionary, NSMutableSet, NSMutableString, NSObject, NSOutputStream, NSString, NSTimer;
