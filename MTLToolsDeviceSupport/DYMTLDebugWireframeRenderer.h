...
@class DYMTLCommonDebugFunctionPlayer, MTLDebugParallelRenderCommandEncoder, MTLDebugRenderCommandEncoder, MTLRenderPassColorAttachmentDescriptor, MTLRenderPassDescriptor, MTLRenderPipelineDescriptor, MTLTextureDescriptor;
@protocol MTLBuffer, MTLCommandBufferSPI, MTLFunction, MTLLibrary, MTLRenderPipelineState, MTLSamplerState, MTLTexture;
...
- (long long)prepareWireframeTextureWithCommandBufferId:(unsigned long long)arg1 commandEncoderId:(unsigned long long)arg2 parallelEncoderId:(unsigned long long)arg3 pipelineId:(unsigned long long)arg4;
- (BOOL)createWireframeRenderCommandEncoder;
- (long long)_prepareWireframeTextureWithEncoder:(id)arg1 andCommandBuffer:(id)arg2 andPipelineState:(id)arg3 andParallelEncoder:(id)arg4;
