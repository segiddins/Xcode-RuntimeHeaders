...
#import <GPUDebuggerFoundation/GPUTraceResourceGroup.h>
...
@interface GPUTraceResourceGroup (GPUTraceOutlineItemNavigableItemPropertySupport) <IDEKeyDrivenNavigableItemRepresentedObject>
