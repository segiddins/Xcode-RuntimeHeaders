...
#import <IDELanguageSupportUI/DVTChooserViewDelegate-Protocol.h>

@class DVTNotificationToken, DVTObservingToken, IDEToyHostingTitleView, NSArray, NSMutableArray, NSString, NSView;
