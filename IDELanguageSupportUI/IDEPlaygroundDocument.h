...
#import <IDELanguageSupportUI/IDESwiftMigrator-Protocol.h>
#import <IDELanguageSupportUI/IDEToyboxDelegate-Protocol.h>

@class DVTFilePath, DVTFuture, DVTNotificationToken, DVTObservingToken, IDEPlaygroundPageSharedContext, IDEPlaygroundSharedContext, IDEToybox, NSArray, NSDictionary, NSError, NSMapTable, NSMutableArray, NSString, NSURL, NSUUID;
...
@interface IDEPlaygroundDocument : IDESourceCodeDocument <IDEToyboxDelegate, IDESwiftMigrator>
{
    ...
    DVTObservingToken *_playgroundContextPageNamesObservingToken;
