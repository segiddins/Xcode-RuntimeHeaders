...
@protocol XRMemoryGraphInspectorFrameViewControllerDelegate;

@interface XRMemoryGraphInspectorFrameViewController : DVTViewController
{
    NSTrackingArea *_rolloverTrackingArea;
    BOOL _mouseIsOver;
    IDEStackFrame *_stackFrameModel;
    id <XRMemoryGraphInspectorFrameViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <XRMemoryGraphInspectorFrameViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
