...
#import <IDEMemoryGraphDebugger/XRMemoryGraphBacktraceInspectorViewControllerDelegate-Protocol.h>

@class IDEInspectorKeyPath, NSMutableArray, NSProgressIndicator, NSString, NSTextField, NSView;

@interface XRMemoryGraphBacktraceInspectorProperty : IDEInspectorProperty <XRMemoryGraphBacktraceInspectorViewControllerDelegate>
{
