...
- (id)historySinceRevisionedBlueprint:(id)arg1 maximumLogItems:(long long)arg2 includeFilePaths:(BOOL)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (id)workingCopyForRemoteRepository:(id)arg1 inBlueprint:(id)arg2;
- (id)historyFromRevisions:(id)arg1 toRevisions:(id)arg2 inclusionType:(unsigned long long)arg3 maximumLogItems:(long long)arg4 searchString:(id)arg5 searchType:(unsigned long long)arg6 includeFilePaths:(BOOL)arg7 incrementalLogBlock:(CDUnknownBlockType)arg8 completionBlock:(CDUnknownBlockType)arg9;
