...
@interface DVTSourceControlSingleFileLogItem : NSObject <NSSecureCoding, NSCopying>
{
...
- (id)description;
- (id)initWithAuthor:(id)arg1 revision:(id)arg2 date:(id)arg3 message:(id)arg4 workingCopy:(id)arg5 currentFilePath:(id)arg6 filePath:(id)arg7 previousFilePath:(id)arg8 status:(unsigned long long)arg9;
