...
@class NSData, NSDictionary, NSError, NSHTTPCookieStorage, NSString, NSURL, XCSEventStream;
@protocol OS_dispatch_queue, XCSServiceBuildDelegate, XCSServiceErrorDelegate;
