...
#import <IDESourceEditor/IDESourceControlLogDetailDelegate-Protocol.h>
#import <IDESourceEditor/NSPopoverDelegate-Protocol.h>

@class CALayer, IDEBlameAnnotationAgeBarView, IDEBlameAnnotationBorderedView, IDESourceCodeBlameController, NSAttributedString, NSButton, NSColor, NSDateFormatter, NSImage, NSNib, NSPopUpButton, NSString, NSView;
...
@interface IDEBlameAnnotationViewController : DVTViewController <NSPopoverDelegate, IDESourceControlLogDetailDelegate>
{
    ...
    NSAttributedString *_displayLogItemMessage;
...
@property(retain, nonatomic) NSAttributedString *displayLogItemMessage; // @synthesize displayLogItemMessage=_displayLogItemMessage;
