...
@interface SKResourceManager : NSObject <DVTInvalidation, IDEMediaLibraryDelegate, GTFFileSystemEventStreamDelegate>
{
    ...
    NSMutableDictionary *_variantResourceCache;
    NSMutableDictionary *_imageCache;
    NSMutableDictionary *_imageObservers;
    NSMutableDictionary *_soundCache;
...
- (id)_nameForVariantSet:(id)arg1 withResource:(id)arg2;
- (void)_startBuildingMediaCache;
