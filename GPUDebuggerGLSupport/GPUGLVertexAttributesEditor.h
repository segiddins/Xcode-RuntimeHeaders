...
#import <GPUDebuggerGLSupport/GPUDataTableViewDataProvider-Protocol.h>
#import <GPUDebuggerGLSupport/GPUDataTableViewDelegate-Protocol.h>

@class DYRenderingAttributes, GPUDataTableView, NSColor, NSObject, NSString;
@protocol GPUGLVertexAttributesProtocol;
