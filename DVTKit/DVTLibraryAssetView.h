...
@class DVTAssetAndGroupSet, NSAttributedString, NSImage, NSString;
...
@property(nonatomic) __weak DVTAssetAndGroupSet *delegate; // @synthesize delegate=_delegate;
