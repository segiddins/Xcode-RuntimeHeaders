...
#import <XCSUI/XCSUICreateBotTriggerCreateCellViewDelegate-Protocol.h>
#import <XCSUI/XCSUICreateBotTriggerViewControllerDelegate-Protocol.h>

@class NSMapTable, NSMutableArray, NSMutableSet, NSString, NSTableView, XCSUIBotDefinitionContext;
