...
+ (id)keyPathsForValuesAffectingIbInspectedDoesNotTranslatesAutoresizingMaskIntoConstraints;
...
+ (BOOL)supportsAlwaysArchiveFramesAsRects;
...
- (BOOL)ibInspectedDoesNotTranslatesAutoresizingMaskIntoConstraints;
...
- (BOOL)ibFrameDecideDuringSceneUpdate;
...
- (BOOL)shouldArchiveFramesForDocument:(id)arg1;
- (BOOL)ibChildrenShouldArchiveRelativeFrames;
- (BOOL)ibShouldArchiveFramesAsRelativeFramesInDocument:(id)arg1;
